...
import useFilterCandidate from "../hooks/useGetOrganization"


export default function CandidateList({id}: {id: number}) {
    
    const {candidates, departments, dataSearch, nextPage, prevPage, pagination, selectRangoPage, firstPage, lastPage, handleChange } = useFilterCandidate(id)
    ...
    return (
        <>
            ...
            <Tabs defaultValue="row">
                ...
                {/* <TabsList>
                    <TabsTrigger value="row">Presidencial</TabsTrigger>
                    <TabsTrigger value="card">Congreso</TabsTrigger>
                    <TabsTrigger value="card">Parlamento</TabsTrigger>
                </TabsList> */}
